...
## Log in Looker using the Lab credentials and toggle Development Mode ON

## Navigate to Develop -> qwiklab-ecommerce -> views and Replace order_items.view file
```
view: order_items {
...
## Navigate to models -> Replace training_ecommerce.model file
```
